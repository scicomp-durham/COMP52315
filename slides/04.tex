...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{exampleblock}{Instrumentation\vphantom{pl}}
        \begin{itemize}
...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.6\textheight]{figures/samplingprofile.png}
  \end{center}
\end{frame}
\begin{frame}
  \frametitle{Tracing}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{center}
        \includegraphics[width=\textwidth]{figures/inclusiveexclusive.png}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
