...
\begin{frame}
  \frametitle{Exercise 3: results (updated)}
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
        group style={
        ...
        every axis plot/.append style={
          ...
          very thick}]
        \pgfplotstableread{multicore_bandwidth.dat}\mydata
        \pgfplotstableread{new_data.dat}\mynewdata

        \nextgroupplot[ticklabel style={font=\tiny},
        label style={font=\scriptsize},
        legend style={font=\scriptsize, fill=bgcolor},
        ylabel={MB/s}, legend pos={north west}]
        \addplot[Blue, dashed, mark=o, mark options=solid] table[x=n_cores, y=L3_BW_s] \mydata;
        \addlegendentry{L3 (1 socket)}
        \addplot[Red, mark=square,] table[x expr=\thisrowno{0}*2, y=L3_BW_d] \mydata;
        \addlegendentry{L3 (2 sockets)}
        ...
        \addplot[Blue, dashed, mark=o, mark options=solid] table[x=n_cores, y=2GB_s] \mynewdata;
        \addlegendentry{2GiB (1 socket)}
        \addplot[Red, mark=square,] table[x expr=\thisrowno{0}*2, y=2GB_d] \mynewdata;
        \addlegendentry{2GiB (2 sockets)}

        \nextgroupplot[ticklabel style={font=\tiny},
        label style={font=\scriptsize},
        xlabel style={yshift=1ex},
        legend style={font=\scriptsize, fill=bgcolor},
        ylabel={MB/s}, xlabel={Cores}, legend pos={north west}]
        \addplot[Blue, dashed, mark=o, mark options=solid] table[x=n_cores, y=4GB_s] \mynewdata;
        \addlegendentry{4GB (1 socket)}
        \addplot[Red, mark=square,] table[x expr=\thisrowno{0}*2, y=4GB_d] \mynewdata;
        \addlegendentry{4GB (2 sockets)}

        \nextgroupplot[ticklabel style={font=\tiny},
        label style={font=\scriptsize},
        legend style={font=\scriptsize, fill=bgcolor},
        xlabel style={yshift=1ex},
        xlabel={Cores}, legend pos={north west}]
        \addplot[Blue, dashed, mark=o, mark options=solid] table[x=n_cores, y=8GB_s] {\mynewdata};
        \addlegendentry{8GB (1 socket)}
        \addplot[Red, mark=square,] table[x expr=\thisrowno{0}*2, y=8GB_d] {\mynewdata};
        \addlegendentry{8GB (2 sockets)}
      \end{groupplot}
    \end{tikzpicture}
  \end{center}
\end{frame}
